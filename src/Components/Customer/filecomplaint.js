...
width: 100,
    ...
    resizeMode: 'contain',
            ...
            <Text style={styles.Text}>FILE COMPLAINT</Text>
            <View>
      ...
      <Button title="Submit" color="green"style={{borderRadius:"10px"}} onPress={handleSubmit} />
            ...
            <Button title="View Complaint Status" color="green"style={{borderRadius:"10px"}} onPress={()=>navigation.navigate("ViewComplaintStatus")} />
